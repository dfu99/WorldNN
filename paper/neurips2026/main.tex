...
The Gaussian-MI correlates with peak SA at $r = 0.975$. This matches the Data
Processing Inequality prediction: capacity cannot recover information absent from
the input. The floor effect at sensory $\leq 4$ corresponds to linear $R^2 < 0.3$.
The information about state is below what the task requires, and no policy
