...
within VAE-only conditions, $r = -0.75$. Four other candidates---prediction
...
scripts (\texttt{experiments/}), raw results in JSON format
(\texttt{results/}), and SLURM scripts for PACE cluster reproduction
(\texttt{slurm/}).
