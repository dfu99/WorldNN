...
SA requires a computable optimal action, feasible in simulation but not in general
real-world tasks. The learnability threshold (SA $\approx 0.4$--$0.5$) may be
...
across physics and appearance variants (89--106\% retention) and its training
slope predicts final success ($r = -0.71$). These results formalize the principle
